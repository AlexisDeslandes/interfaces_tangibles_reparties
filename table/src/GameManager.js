...
class GameManager {
    ...
    initCanvas(nb) {
        ...
        const ctxJeanP1 = jeanP1[0].getContext("2d"); const  ctxBikeP1 = bikeP1[0].getContext("2d");
        const jeanP2 = $("#jean-p2"); const bikeP2 = $("#bike-p2");
        const ctxJeanP2 = jeanP2[0].getContext("2d"); const  ctxBikeP2 = bikeP2[0].getContext("2d");
        const jeanP3 = $("#jean-p3"); const bikeP3 = $("#bike-p3");
        const ctxJeanP3 = jeanP3[0].getContext("2d"); const  ctxBikeP3 = bikeP3[0].getContext("2d");
        const jeanP4 = $("#jean-p4"); const bikeP4 = $("#bike-p4");
        const ctxJeanP4 = jeanP4[0].getContext("2d"); const  ctxBikeP4 = bikeP4[0].getContext("2d");
        ...
        switch (nb) {
            case 1:
                ...
                jeanP1.attr("width", jeanWidth); jeanP1.attr("height", jeanHeight);
                jeanP1.css("bottom", 0.01*$(window).height()); jeanP1.css("right", 0.1*$(window).width());
